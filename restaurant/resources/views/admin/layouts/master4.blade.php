            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-table" aria-hidden="true"></i> Lương theo tháng<span class="fa arrow"></span></a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href=""><i class="fa fa-calendar" aria-hidden="true"></i> Lịch làm việc<span class="fa arrow"></span></a>
                            <!-- /.nav-second-level -->
                        </li>
                        @endif
                    </ul>
