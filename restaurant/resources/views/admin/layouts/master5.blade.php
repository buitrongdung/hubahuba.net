...
<head>
    ...
    <title>Employer - Restaurant</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Thông tin nhân viên</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        @if (Auth::check() && Auth::user()->isNhanVien()) 
                        <li>
                            <a href="#"><i class="fa fa-bars"></i> Thông tin nhân viên<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="fa fa-users " href="{{route('admin.employer.listEmployer')}}"> Thông tin cá nhân</a>
                                </li>
                                <li>
                                    <a class="fa fa-calendar" href="{{route('admin.employer.calendar')}}"> Lịch làm việc</a>
                                </li>
                                <li>
                                    <a class="fa fa-table" href="{{route('admin.employer.chamCong')}}"> Bảng công</a>
                                </li>
                                <li>
                                    <a class="fa fa-money" href="{{route('admin.employer.saraly')}}"> Tiền lương</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.employer.getpassword')}}"> Thay đổi mật khẩu</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
