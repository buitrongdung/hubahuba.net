    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin quản trị nhân viên</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         @if (Auth::check() && Auth::user()->isAdminNhanSu())
                         <li>
                            <a href="#"><i  class="fa fa-user"></i> Nhân viên<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('admin.employer.list')}}">Danh sách nhân viên</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.employer.lichLamViec')}}"><i class="fa fa-calendar" aria-hidden="true"></i> Lịch làm việc</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table" aria-hidden="true"></i> Bảng lương nhân viên<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href=" {{route('admin.saraly.list')}} "> Bảng lương chức vụ</a>
                                </li>
                                <li>
                                    <a href=" {{route('admin.saraly.listChamCong')}} "> Bảng chấm công</a>
                                </li>
                                <li>
                                    <a href=" {{route('admin.saraly.saralyEmployer')}} "> Bảng lương nhân viên</a>
                                </li>
                            </ul>
                        </li> 
                        @endif
