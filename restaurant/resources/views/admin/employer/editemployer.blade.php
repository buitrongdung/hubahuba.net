            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
						<form id="formEditEmployee" method="POST" action="{{route('admin.employer.update', $emp->id_employer)}}" class="form-horizontal">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
		                              <select class="form-control" name="type_employer" id="type_employer">
										  <option style="background-color: silver" value="{{$emp->TypeEmployer->id_employer}}">{{$emp->TypeEmployer->description}}</option>
		                               @foreach($types as $type)
			                              <option value="{{$type->id_employer}}">{{$type->description}}</option>
			                              @endforeach
		                              </select>
		                             </div>
	                            </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="cmnd" value="{{$emp->cmnd}}" class="form-control" maxlength="15">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="phone" value="{{$emp->phone}}" class="form-control" maxlength="11">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Tôn giáo </label>
									<div class="col-sm-6">
										<input type="text" name="religion" value="{{$emp->religion}}" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Dân tộc </label>
									<div class="col-sm-6">
										<input type="text" name="ethnic" value="{{$emp->ethnic}}" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Quốc tịch </label>
									<div class="col-sm-6">
										<input type="text" name="country" value="{{$emp->country}}" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Bằng cấp </label>
									<div class="col-sm-6">
										<textarea type="text" name="diploma" class="form-control">
										{{$emp->diploma}}
										</textarea>
									</div>
								</div>
