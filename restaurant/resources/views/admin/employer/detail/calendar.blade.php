    ...
    <div id="page-wrapper">
        <div class="container-fluid" style="margin-left: -59px;">
            <div class="col-lg-12" style="margin-left: 38px;">
                ...
                <form method="post" action="{{ route('admin.employer.showCalendar') }}" id="formShowCalendarWithEmp">
            ...
            <div class="panel-body">
                @if (!isset($currentMonth, $currentYear))
                    <table class="table table-striped table-bordered table-hover"
                        ...
                        <caption><h3>Lịch làm việc tháng <?=date('m') + 1?></h3></caption>
                        <thead>
